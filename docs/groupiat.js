define(['pipAPI', 'https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.*/IAT/iat6.js'], function(APIConstructor,iatExtension){
	...
	return iatExtension({
		...
		category1 : {
			name : global.domcatname,
			title : {
				media : {word : global.domcatname}, //Name of the category presented in the task.
		...
		category2 :	{
			name :  global.nondomcatname,
			title : {
				media : {word : global.nondomcatname}, //Name of the category presented in the task.
				css : {color:'#31b404','font-size':'1.8em'}, //Style of the category title.
				height : 4//Used to position the "Or" in the combined block.
			}, 
			stimulusMedia : [ 
